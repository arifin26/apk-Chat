...
import {View,Text,StyleSheet,TextInput,Alert,Modal,ActivityIndicator,ScrollView,AsyncStorage,Button,Image,FlatList,PermissionsAndroid,Platform,TouchableOpacity, ImageBackground} from 'react-native'
...
export default class Akun extends React.Component{
  ...
  componentDidMount(){
    ...
    AsyncStorage.getItem('telp').then
    (value => {
      if (value != null) {
...
ImageToServer = () => {
 ...
 render() {
      ...
      <View style={{alignItems:'center',justifyContent:'center',alignSelf:'center',marginTop:20,borderWidth:2,borderRadius:94,borderColor:'#633689',width: 205, height: 205,}}>
          {/*<Image 
          ...
          <View style={{marginTop:100,borderWidth:2,width:290,borderRadius:40,height:200}}>
      ...
      <Modal 
                  ...
                  >
                    ...
                    <View style={{height:578,width:347,borderColor:'#633689',borderRadius:60,borderWidth:7}}>
                    <View style={{height:560,width:330,backgroundColor:'#fff',borderRadius:50}}>
                    <View style={{flexDirection:'row'}}>
                    <View style={{borderWidth:4,borderRadius:94,borderColor:'#633689',width: 117, height: 117,marginLeft:30,marginTop:10}}>
                    {/* <Image 
                          source={{
                            uri: 'data:image/jpeg;base64,' + this.state.filePath.data,
                          }} 
                    ...
                    <View style={{paddingLeft:130,paddingTop:10}}>
                      <Image source={require('../gambar/icons8-delete-104.png')} style={{height:33,width:33}}/>
                    </View>
                    </TouchableOpacity>
                    </View>
                    ...
                    <TextInput 
                      ...
                      onChangeText={ TextInputValue => this.setState({ text_email : TextInputValue }) }
                    ...
                    <TextInput 
                      ...
                      onChangeText={ TextInputValue => this.setState({ text_telp : TextInputValue }) }
                    ...
                    <TouchableOpacity  onPress={this.ImageToServer} 
                                                    style={{width: '40%',
                                                    padding: 5,
                                                    backgroundColor: '#fff',
                                                    elevation:10,
                    ...
                    <TouchableOpacity onPress={this.selectPhotoTapped.bind(this)}
                                ...
                                <Text style={{textAlign:'center',fontSize:20}}>pilih foto</Text>
